/*
   ...
   Для измерения был выбран датчик CO2 AGS10, но он оказался не исправным.
   Код написан для абстрактного сенсора, в роли которого выступил потенциометр.
...
// Для включение замкнуть на массу, предполагается использование пищалки со встроенным контроллером
